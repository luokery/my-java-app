 ...
 */
@Component
public class DataIntegrityViolationExceptionHandler implements ExceptionHandlerPolicyModel<DataIntegrityViolationException> {

	@Override
	public Class<DataIntegrityViolationException> sequence() {
		return DataIntegrityViolationException.class;
	}

	@Override
	public ResponseVO<?> handler(DataIntegrityViolationException exception) {
